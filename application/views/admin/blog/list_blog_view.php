<div class="content-wrapper" style="min-height: 916px;">
    <section class="content row">
        <div class="container col-md-12">
            ...
            <div class="row">
                <div class="col-md-6">
                    <a type="button" href="<?php echo base_url('admin/blog/create') ?>" class="btn btn-primary">THÊM MỚI</a>
                </div>
                            ...
                            <tbody>
                                ...
                                <?php foreach ($result as $key => $value): ?>
                                     <tr class="remove_<?php echo $value['id'] ?>" >
                                        ...
                                        <td><a href="<?php echo base_url('admin/blog/detail/'. $value['id']) ?>" title="Chi tiết" class="btn btn-primary">Xem</a></td>
                                        <td>
                                            <a href="<?php echo base_url('admin/blog/edit/'. $value['id']) ?>" title="Sửa"><i class="fa fa-fw fa-edit"></i></a>
                                            &nbsp&nbsp&nbsp&nbsp&nbsp
                                            <a href="javascript:void(0);" title="Xóa" class="btn-remove" onclick="remove('blog', <?php echo $value['id'] ?>, 'Chắc chắn xóa?)')" >
